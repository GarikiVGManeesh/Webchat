 ...
 */
const createUploadMiddleware = (folderName = 'general', allowedFormats = null, maxSize = 10 * 1024 * 1024) => {
...
module.exports = { avatarUpload, messageFileUpload, createUploadMiddleware };
