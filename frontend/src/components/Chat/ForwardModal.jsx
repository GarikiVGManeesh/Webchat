        ...
        <div className="p-3 border-b border-gray-100 dark:border-dark-700">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-teal-500/10 dark:bg-white/5 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
            />
          </div>
        </div>
            ...
            filteredChats.map((chat) => {
              ...
              return (
                <button
                  ...
                  disabled={forwarding}
                  className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-teal-500/10 dark:hover:bg-white/5 transition-all disabled:opacity-50"
                >
                  {avatar ? (
