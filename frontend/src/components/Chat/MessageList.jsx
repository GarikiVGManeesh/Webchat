    ...
    >
      ...
      {showScrollBtn && (
        <button
          ...
          className="absolute bottom-4 right-4 z-20 w-10 h-10 glass rounded-full shadow-lg flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-teal-500/10 dark:hover:bg-white/10 transition-all animate-fade-in-up hover:scale-110 active:scale-95"
